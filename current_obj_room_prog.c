...
#define CHK_ISTARGET    (21)
#define CHK_EXISTS      (22)
#define CHK_AFFECTED    (23)
#define CHK_ACT         (24)
#define CHK_OFF         (25)
#define CHK_IMM         (26)
#define CHK_CARRIES     (27)
#define CHK_WEARS       (28)
#define CHK_HAS         (29)
#define CHK_USES        (30)
#define CHK_NAME        (31)
    ...
    while ( *code )
    {
        ...
        */
        if ( !str_cmp( control, "if" ) )
        {
            ...
            if ( obj && ( check = keyword_lookup( fn_keyword, control ) ) >= 0 )
            {
